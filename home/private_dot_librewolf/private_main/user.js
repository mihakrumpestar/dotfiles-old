...
user_pref("ui.systemUsesDarkTheme", 1); // Dark theme prefered
user_pref("layout.css.prefers-color-scheme.content-override", 0); // Force dark mode

user_pref("browser.startup.page", 3); // set startup page: 0=blank, 1=home, 2=last visited page, 3=resume previous session
user_pref("browser.startup.homepage", "moz-extension://d1422480-e263-4c0b-9e40-a50e97615a6a/index.html"); // set HOME+NEWWINDOW page
...
user_pref("general.useragent.override", "Mozilla / 5.0 Gecko Firefox") // Does not work when resistFingerprinting is enabled
